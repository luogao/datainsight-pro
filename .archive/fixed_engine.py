...
Detected {result.get('anomaly_count', 0)} anomalies
...
class DataAnalysisEngine:
    ...
    def analyze(self, goal, dataset_path, depth="standard"):
        ...
        print(f"   Average value: {self.reporter._format_number(stats['avg_value'])}")
        ...
        recommendations = self._generate_recommendations(findings, growth_analysis, anomalies)
...
"""
    ...
    def _generate_recommendations(self, findings, growth_analysis, anomalies):
        recommendations = []
...
if __name__ == '__main__':
    print("=" * 60)
    print("DataInsight Pro - Fixed Version")
    print("=" * 60)
